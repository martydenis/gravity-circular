import { dpi, hexToRGB, randomIntFromRange, randomValueFromArray, getDistance, initControls, initStopPropagation } from './sandbox-utils/utilities.js';
...
class Circle {
    ...
    update(delta) {
        ...
        this.distance += this.velocity.v * delta;
...
function updateGame() {
    newTime = new Date();
    const delta = (newTime - oldTime) * 0.075;
